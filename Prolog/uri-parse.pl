...
crea_porta_z([Testa | Coda], ListPort, Scheme, UserInfo, Host, Porta) :- atomics_to_string([Testa | Coda], Porta),
    writeln(Porta),
    path_z_id44(Scheme, UserInfo, Host, ListPort, Porta, _, _).
riempi_lista_path_z(Scheme, UserInfo, Host, Porta, Cont, [Testa | Coda], Lista, [Testa | Lista]) :- Cont is 0,
...
path_z_id44(_, _, _, [], _, _, _).
path_z_id44(Scheme, UserInfo, Host, [Testa | Coda], Porta, [], Cont) :- Cont is 0,
    riempi_lista_path_z(Scheme, UserInfo, Host, Porta, Cont, [Testa | Coda], [], ListPath).
path_z_id44(Scheme, UserInfo, Host, [Testa, Testa1 | Coda], Porta, ListPath, Cont) :- (Testa \= '?' ->
                                                                         (   ((Testa == '.', Testa1 \= '(');
                                                                         (Testa \= '.', Testa1 \= '('))  ->
                                                                         (   Cont < 44 ->
                                                                         append([Testa], ListPath, List),
                                                                         path_z_id44(Scheme, UserInfo, Host, Coda, Porta, List, Cont1),
                                                                             Cont1 is Cont+1;
                                                                         (   Cont == 44 ->
                                                                         append([Testa], ListPath, List),
                                                                         path_z_id44(Scheme, UserInfo, Host, Coda, Porta, List, Cont);
                                                                         !);! );
                                                                         (   Testa == '(' ->
                                                                         append([Testa], ListPath, List),
                                                                         path_z_id8(Scheme, UserInfo, Host, [Testa1 | Coda], Porta, List, _)))).
path_z_id8(Scheme, UserInfo, Host, [Testa | Coda], Porta, ListPort, Cont) :- (Testa \= ')' ->
                                                                             (   Cont < 8 ->
                                                                             Cont is Cont+1,
                                                                             append([Testa], ListPort, List),
                                                                             path_z_id8(Scheme, UserInfo, Host, [Testa | Coda], Porta, List, Cont);
                                                                             !);
                                                                             append([Testa], ListPort, List),
